...
# Tahmin yap
y_pred_logreg = logreg_model.predict(test_x)

# Performansı değerlendir
print("Logistic Regression Accuracy:", accuracy_score(test_y, y_pred_logreg, normalize=True))
